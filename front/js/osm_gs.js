...
var name_layer_point = "formation_gs:point_shapes";
var name_layer_line = "formation_gs:line_shapes";
...
var lyr_point = new ol.layer.Tile({
  source: new ol.source.TileWMS({
    url: url_geoserver,
    params: { LAYERS: name_layer_point, TILED: "true" },
  }),
  title: "point",
});
var lyr_line = new ol.layer.Tile({
  source: new ol.source.TileWMS({
    url: url_geoserver,
    params: { LAYERS: name_layer_line, TILED: "true" },
  }),
  title: "line",
});
...
lyr_point.setVisible(true);
lyr_line.setVisible(true);
